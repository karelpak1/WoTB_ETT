...
For WoTB version: 8.10.x (only steam or download a modded apk file)
...
Installation for Windows store version:
	...
	Move with unlocker the entire folder Data folder in to your working directory (for ex. Desktop)
		C:\Program Files\WindowsApps\7458BE2C.WorldofTanksBlitz_8.10.XXX.X_x64__x4tje2y229k00
...
========================================================================================
|Этот мод был создан _Mitarka#1275. На данную модификацию не распространяется гарантия.|
========================================================================================
		!!! Всегда делайте резервную копию перед использованием модификаций!!!

Актуально для: 8.10.x (только Steam или загруженный модифицированный apk-файл)
...
Установка для версии Windows store:
	!!! Для продвинутых пользователей !!!
	Загрузите и установите iobit unlocker (https://www.iobit.com/en/iobit-unlocker.php)
	Переместите с помощью unlocker всю папку Data folder в вашу рабочую директорию (например, на рабочий стол).
		C:\Program Files\WindowsApps\7458BE2C.WorldofTanksBlitz_8.10.XXX.X_x64__x4tje2y229k00
	Распакуйте .dvpl с помощью DVPL конвертера (https://dvpl.iblitzmods.ru)
	Скопируйте извлеченные файлы в перемещенную папку Data на рабочем столе.
	Подтвердите замену файлов.
	Верните папку Data обратно с помощью iobit unlocker.
		C:\Program Files\WindowsApps\7458BE2C.WorldofTanksBlitz_8.10.XXX.X_x64__x4tje2y229k00
	Если вы сделали всё правильно, то игра должна запуститься.
