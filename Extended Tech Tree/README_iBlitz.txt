...
For WoTB version: 8.4.x (only steam or download a modded apk file)
...
Installation for Windows store version:
	...
	Move with unlocker the entire folder Data folder in to your working directory (for ex. Desktop)
		C:\Program Files\WindowsApps\7458BE2C.WorldofTanksBlitz_8.4.XXX.X_x64__x4tje2y229k00
...
Актуально для: 8.4.x (только Steam или загруженный модифицированный apk-файл)
